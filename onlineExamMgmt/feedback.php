    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Subhash Sahu</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+916261833571</h4>
		<h4 style="font-family:'typo' ">shubhsahu10720@gmail.com</h4>
		<h4 style="font-family:'typo' ">Goverment Polytechnic Collage,Anuppur:-484224</h4></div></div>
		</p>
      </div>
